	...
	<div  class="col-md-6 col-md-offset-3">
				...
				<form action="<%=request.getContextPath()%>/register" method="post">
					...
					<div style="text-align: center;font-weight: 900;font-style:oblique;font-size: x-large;" class="form-group">
						<label  for="uname">الإسم</label> <input style="border: 4px double #FF6347;font-weight: 900;text-align: center;font-size: large;color:#1C006C" type="text"
							class="form-control" id="uname" placeholder="أدخل الإسم"
							name="firstName" required>
					</div>

					<div style="text-align: center;font-weight: 900;font-style:oblique;font-size: x-large;" class="form-group">
						<label for="uname">اللقب</label> <input style="border: 4px double #FF6347;font-weight: 900;text-align: center;font-size: large;color:#1C006C" type="text"
							class="form-control" id="uname" placeholder="أدخل اللقب"
							name="lastName" required>
					</div>

					<div style="text-align: center;font-weight: 900;font-style:oblique;font-size: x-large;" class="form-group">
						<label for="uname">إسم المستخدم </label> <input style="border: 4px double #FF6347;font-weight: 900;text-align: center;font-size: large;color:#1C006C" type="text"
							class="form-control" id="username" placeholder="أدخل إسم المستخدم"
							name="username" required>
					</div>

					<div style="text-align: center;font-weight: 900;font-style:oblique;font-size: x-large;" class="form-group">
						<label for="uname">كلمة المرور</label> <input style="border: 4px double #FF6347;font-weight: 900;text-align: center;font-size: large;color:#1C006C" type="password"
							class="form-control" id="password" placeholder="أدخل كلمة المرور"
							name="password" required>
					</div>

					<button style ="width:60%;margin-left:22%;font-weight: 900;font-style: oblique;font-size: large;background-color:  #1D5DF0 " type="submit" class="btn btn-primary">تسجيل</button>
