...
<body>
    ...
    height: 40px;">
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<ul class="navbar-nav">
			  ...
			  <div style="position:relative;margin-left:74%">
	...
	<div style="float:left;margin-left:2%;margin-top: 5%;margin-bottom: 5%" class="row">
		...
		<div class="container" >
			<h1 style=" width:130%;font-weight: 900" class="text-center">Liste des personnels</h1>
			<hr style="width: 130%;border: 5px outset #33F3FF;">
			<div class="container text-left">

				<a style="font-weight: 800" href="<%=request.getContextPath()%>/newF" class="btn btn-success">Ajout d'un nouveau personnel</a>
			</div>
			<br>
			<table style="width: 130%; border: 3px solid black;"class="table table-bordered">
				<thead>
					<tr style="text-align:center;font-size: large;font-style:oblique; background-color: #C4FFBA ; border: 3px solid black;">
						<th  style="border: 3px solid black; ">MATRICULE</th>
						<th style="border: 3px solid black;">NOM ET PRENOM</th>
						<th style="border: 3px solid black;">GRADE</th>
						<th style="border: 3px solid black;">LIEU DE TRAVAIL</th>
						<th style="border: 3px solid black;">Email</th>
						<th style="border: 3px solid black;">TELEPHONE</th>
						<th style="border: 3px solid black;">ADRESSE</th>
				...
				<tbody>
					...
					<c:forEach var="personnel" items="${listPersonnel}">
							...
							<tr style="text-align:left; border: 3px solid black;">
							...
							<td style="border: 3px solid black;"><a href="editF?mat=<c:out value='${personnel.mat}' />"> <button  class="pushable_edit"><span class="front_edit">Edit</button></span></a>
								 <a
								href="deleteF?mat=<c:out value='${personnel.mat}' />"><button  class="pushable"><span class="front">Delete</button></span></a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
